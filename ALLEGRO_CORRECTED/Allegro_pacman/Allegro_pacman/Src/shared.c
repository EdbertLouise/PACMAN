...
ALLEGRO_FONT* LFont = NULL;
ALLEGRO_FONT* WFont = NULL;
int fontSize1 = 30;
int fontSize2 = 80;
int fontSize3 = 50;
...
void shared_init(void) {
	...
	menuFont = load_font("Assets/Minecraft.ttf", fontSize1);
	LFont = load_font("Assets/Minecraft.ttf", fontSize2);
	WFont = load_font("Assets/Minecraft.ttf", fontSize3);
